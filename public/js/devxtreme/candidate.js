...
var gridData = $('#gridData').dxDataGrid({
    ...
    columns: [{
            ...
            cellTemplate: function (container, options) {
                $('<a/>').addClass('dx-link')
                    .text('Xem')
                    .attr("href", "/candidate/edit/" + options.data.id)
                    .appendTo(container);
            }
        },
        {
    ...
    onToolbarPreparing: function (e) {
        e.toolbarOptions.items.unshift(
            ...
            },
            {
                ...
                options: {
                    ...
                    onClick: function (e) {
                        let a = document.createElement("a");
                        a.target = "_blank";
                        a.href = "/candidate/import-history";
                        a.click();
                    },
                },
            }, //import file
            ...
            //             let a = document.createElement("a");
            //             a.target = "_blank";
            //             a.href = "/candidate/export-candidate";
            //             a.click();
            //         },
            //     },
            // },
...
$(".changeCandidate").on("click", function (e) {
    ...
    $.ajax({
        ...
        dataType: "JSON",
        type: "post",
        url: "/api/candidate/change-to-candidate/" + dataId,
        success: function (resp) {
            if (resp.success == true) {
